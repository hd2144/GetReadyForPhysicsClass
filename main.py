#1. Write a function called f_to_c that takes an input f_temp, a temperature in Fahrenheit, and converts it to c_temp, that temperature in Celsius.It should then return c_temp. The equation you should use is:
...
print(train_force)
print("The GE supplies " + str(train_force) + " Newtons of force.")
...
acceleration = 0
def get_work(mass, accelration, distance):
